              ...
              return(
                <div key={id}className='list-paragraph'>
                  <ul>
                    ...
                    <li>{theme.theme}</li>
                    <li>
                      <Icon onClick = {()=>{console.log("Icon")}} className='edit'  sx={{color: '#1e1e1e'} } ><EditIcon/></Icon>
                      <Icon className='delete' sx={{color: '#1e1e1e'}} onClick={()=> handleClickDele(theme.id_theme)} ><DeleteIcon/></Icon>
                    </li>
                  </ul>
                </div>
              )
